...
%>
        ...
        <script src="js/jquery.min.js"></script>
             <script>
                 function app(rqid){
                     $.ajax({url: "Ajaxapprove.jsp?app="+rqid, success: function(result){
                     $("#show").html(result);
                           var res=$.trim(result);
                           if(res=="true")
                           {
                               alert("Request Approved..!");
                               window.location.href("http://localhost:8084/Rent_A_Trip/Admin/viewrequests.jsp");
                           }
    ...
    <body>
           ...
           <%
            ...
            String ss="update tbl_request set status=1 where request_id='"+rqid+"'";
            obj.insert(ss);
            }
            %>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="page-content">
                            ...
                            <div class="rides-list">
                                ...
                                String new1="select * from tbl_request r,tbl_strip s,tbl_vehicle v,tbl_users u where r.trip_id=s.strip_id and v.vehicle_id=s.vehicle_id and u.user_id=v.user_id and u.user_id='"+userig+"'";
                                ...
                                <article class="ride-box clearfix">
                                    ...
                                    <ul class="ride-meta">
                                        ...
                                        <li>
                                            ...
                                            %>
                                            <a href="viewrequests.jsp?id=<%=rqid%>">Approve</a>
                                            <% }  %>
...
%><center> You don't have any requests </center> <%
}

...
<!--                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="upcomingtrips.jsp" >
                          <i class="fa fa-tasks"></i>
				...
				<div class="row">
	                  ...
	                  <div class="col-md-12">
	                  	  <div class="content-panel">
                                ...
                                String new1="select * from tbl_strip s,tbl_type t,tbl_vehicle v,tbl_users u where v.vehicle_id=s.vehicle_id and u.user_id=v.user_id and t.type_id=v.type_id and s.strip_date>CURDATE() ORDER BY s.strip_id desc";

...
<!--                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="userlists.jsp" >
				...
				<div class="row">
	                  ...
	                  <div class="col-md-12">
	                  	  <div class="content-panel">
                                ...
                                String new1="select * from tbl_users";
                                ResultSet newrs1=obj.select(new1);
                                int c=0;
                                int n=1;
                                while(newrs1.next()){
                                String name=newrs1.getString("firstname")+" "+newrs1.getString("lastname");
                                String un=newrs1.getString("username");
                                String pswd=newrs1.getString("password");
                                String email=newrs1.getString("email");   
                                String ph=newrs1.getString("phone");
                                String addr=newrs1.getString("address");

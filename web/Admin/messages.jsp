<%-- 
    Document   : messages
    Created on : Oct 25, 2017, 7:43:45 AM
    Author     : Jayashankar
--%>
...
<!--                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                          <a class="active" href="messages.jsp">
				...
				<div class="row">
	                  ...
	                  <div class="col-md-12">
	                  	  <div class="content-panel">
                                ...
                                String new1="select * from tbl_users u, tbl_comment c where u.user_id=c.user_id";
                                ResultSet newrs1=obj.select(new1);
                                int c=0;
                                int n=1;
                                while(newrs1.next()){
                                String name=newrs1.getString("u.firstname")+" "+newrs1.getString("u.lastname");
                                String un=newrs1.getString("u.username");
                                String msg=newrs1.getString("c.comment");
                                String email=newrs1.getString("u.email");   
                                %>
